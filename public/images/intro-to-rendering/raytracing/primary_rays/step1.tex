...
\begin{tikzpicture}[common settings]
    ...
    \def\pixSize{0.8}  % Size of each pixel
    ...
    \foreach \ix in {0,...,4} {
        \foreach \iy in {0,...,4} {
            ...
            \fill[orange] (-\halfW + \ix * \pixSize, \halfW - \iy * \pixSize, -\zdist) circle (1.0pt);
            
            \node[scale=0.7, text=cyan!40!black] at (\px, \py, -\zdist) {(\ix,\iy)};
        }
    }
...
\begin{tikzpicture}[common settings]
    ...
    \foreach \ix in {0,...,4} {
        \foreach \iy in {0,...,4} {
            ...
            \fill[orange] (\px, \py, -\zdist) circle (1.0pt);
            
            \node[scale=0.7, text=cyan!40!black] at (\px, \py, -\zdist) {(\ix.5,\iy.5)};
        }
    }
