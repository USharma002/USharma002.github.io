...
\begin{tikzpicture}[>=latex, font=\normalsize, line width=0.6pt]
    ...
    \draw[axisred, -latex, line width=2pt] (0,0) -- (0,-2.5) node[right, text=black] {$X$};
    ...
    \draw[decorate, decoration={brace, amplitude=6pt, mirror}, thick] 
        (\n + 0.1, 0) -- (\n+ 0.1, \h) node[midway, right=8pt, font=\large] {$r$};

    % 7. Right Angle Marker
    \draw (\n-0.3, 0) -- (\n-0.3, 0.3) -- (\n, 0.3);

    % 8. Angles
    \pic[draw, "$\frac{\alpha}{2}$", angle eccentricity=1.4, angle radius=1.2cm] {angle = M--O--T};
    \pic[draw, "$\frac{\alpha}{2}$", angle eccentricity=1.4, angle radius=1.2cm] {angle = B--O--M};
