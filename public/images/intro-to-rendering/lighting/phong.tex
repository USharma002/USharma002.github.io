...
\draw[-Latex, gray!80!black, densely dashed, thick] (Ltip) -- (Nproj) node[midway, above=2pt, font=\large] {$(\mathbf{n} \cdot \mathbf{l})\mathbf{n} - \mathbf{l}$};

% Second step: Completing the parallelogram to r
\draw[-Latex, gray!80!black, densely dashed, thick] (Nproj) -- (Rtip);
